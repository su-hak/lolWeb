...
public class ProbuildController {
    ...
    @GetMapping("/probuild")
    public String getLeagueInfo(Model model, @RequestParam(defaultValue = "0") int page) {
        ...
        // 현재 페이지의 데이터를 가져옵니다.
        List<LeagueEntryDTO> currentPageEntries = getCurrentPageEntries(allLeagueEntries, page, pageSize);
